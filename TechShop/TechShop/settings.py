...
SECRET_KEY = 'django-insecure-2%b3dmsk*idi3=901adxqg5jvmp0_l%-x89-g9iz0(kzc(0r2l'
...
# The key that you are going to use to store the cart in the user session.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cart.context_processors.cart', #The cart context processor will be executed every time a template is rendered using Django's RequestContext. 
            ],
        },
    },
]
