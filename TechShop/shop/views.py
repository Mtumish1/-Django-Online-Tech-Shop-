...
#You can get this instance just through the ID,since it's a unique attribute.
#However, you include the slug in the URL to build SEO-friendly URLs for products.